...
SC_UTXO_VALUE="5000000"
issuer_address_out="$issuer_address + $SC_UTXO_VALUE"

SC_UTXO_VALUE=$((11344798 - 5000000))
...
FEE=$(${cli} transaction build \
    ...
    --tx-in ${script_tx_in}  \
    --tx-in-datum-file data/join_datum.json \
    --tx-in-redeemer-file data/player_two_leave_redeemer.json \
